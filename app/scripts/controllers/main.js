...
var nectarineApp = angular.module('nectarineApp')
    nectarineApp.directive('ghVisualization', function () {
  ...
  nectarineApp.controller('MainCtrl', function ($scope, $http, angularFire){
